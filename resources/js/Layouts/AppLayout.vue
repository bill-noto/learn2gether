        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('hosts')" :active="route().current('hosts')">
                                    Hosts
                                </jet-nav-link>
                            </div>
                                    ...
                                    <template #trigger>
                                        <button v-if="$page.props.jetstream.managesProfilePhotos"
                                            ...
                                            <img class="h-8 w-8 rounded-full object-cover"
                                                 :src="$page.props.user.user_avatar" :alt="$page.props.user.name"/>
                                        </button>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link :href="route('hosts')" :active="route().current('hosts')">
                            Hosts
                        </jet-responsive-nav-link>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            <div v-if="$page.props.jetstream.managesProfilePhotos" class="shrink-0 mr-3">
                                <img class="h-10 w-10 rounded-full object-cover" :src="$page.props.user.user_avatar"

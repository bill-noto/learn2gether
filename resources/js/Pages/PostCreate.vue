            ...
            <div class="flex justify-center mx-10 p-4 my-10 shadow-md">
                <div class="2xl:w-4/6 xl:w-4/6 lg:w-4/6 md:w-4/6 w-full">
                    <form @submit.prevent="submit">
                        <div class="pb-4">
                            ...
                            <select name="author" id="author" class="w-full h-10 p-1">
                                <option :value="this.user.id" selected>{{ this.user.name }}</option>
                            </select>
                        </div>
                        <div class="py-4">
                        ...
                        <div class="py-4">
                            ...
                            <textarea v-model="this.form.content"
                                      type="text" class="w-full h-32 p-1" id="content" placeholder="Post Content Here"
                    ...
                    <Link :href="route('posts')">
                        <button
                            class="inline-flex text-md sm:text-xl transition-colors duration-200 focus:ring-2 focus:ring-offset-2 focus:ring-current focus:outline-none rounded-md text-white bg-red-500 hover:bg-red-700 px-4 py-2 my-2 w-1/3 my-4">
                            Cancel
                        </button>
                    </Link>
                </div>
